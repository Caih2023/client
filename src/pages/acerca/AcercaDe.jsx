          ...
          <div className="relative h-[30rem] sm:h-96 w-[60rem] rounded-lg">
            ...
            <div className="absolute w-full h-full bottom-0 bg-gradient-to-r from-slate-400/20 to-slate-700 rounded-lg flex flex-col items-center justify-center text-center">
              ...
              <p className="text-lg font-semibold px-5 text-white">
                ...
                fue creado el 01 de octubre de 2018 en conmemoración por el día
                internacional del Arquitecto. Fundado por un grupo de
                arquitectos e Ingenieros civiles con interés por el desarrollo
                urbano y ordenamiento territorial de nuestra región. El objetivo
                de nuestro colegio es el trabajar activamente en propuestas de
                intervención urbano-arquitectónicas en colaboración con
                organismos gubernamentales o autónomos, con el fin de mejorar la
                experiencia y habitabilidad de la población en nuestra ciudad y
                región.
              </p>
            </div>
          </div>
